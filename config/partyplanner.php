    ...
    */
    ...
    'payments' => [
        ...
        'pawapay' => [
            ...
            'test_amount' => env('PAWAPAY_TEST_AMOUNT'),
            'test_currency' => env('PAWAPAY_TEST_CURRENCY', 'XOF'),
            ...
            'countries' => [
                'COG' => [
                    ...
                    'currency' => 'XAF',
                    'calling_code' => '242',
                    'national_phone_regex' => '/^0[456]\d{7}$/',
                    'providers' => [
                        'MTN_MOMO_COG' => ['name' => 'MTN Mobile Money', 'prefixes' => ['06']],
                        'AIRTEL_COG' => ['name' => 'Airtel Money', 'prefixes' => ['04', '05']],
                    ],
                ],
                'COD' => [
                    'iso2' => 'CD',
                ...
                'CIV' => [
                    ...
                    'currency' => 'XOF',
                    'calling_code' => '225',
                    'national_phone_regex' => '/^0[157]\d{8}$/',
                    'providers' => [
                        'ORANGE_CIV' => ['name' => 'Orange Money', 'prefixes' => ['07']],
                        'MTN_MOMO_CIV' => ['name' => 'MTN Mobile Money', 'prefixes' => ['05']],
                        'WAVE_CIV' => ['name' => 'Wave', 'prefixes' => ['01']],
                    ],
                ],
            ],
            'callbacks' => [
