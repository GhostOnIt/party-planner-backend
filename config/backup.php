...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('BACKUP_NAME', 'party-planner'),

        'source' => [
            'files' => [
                /*
                 * Vide par défaut : les sauvegardes planifiées utilisent `backup:run --only-db`.
                 */
                'include' => [],
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', env('FEEDBACK_MAIL_TO', 'your@example.com')),
    ...
    'monitor_backups' => [
        [
            'name' => env('BACKUP_NAME', 'party-planner'),
            'disks' => [env('BACKUP_DISK', 's3-backups')],
            'health_checks' => [
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'keep_all_backups_for_days' => (int) env('BACKUP_RETENTION_DAYS', 90),

            /*
             * Pas d'éclaircissement daily/weekly : on conserve tout pendant 90 jours puis suppression.
             */
